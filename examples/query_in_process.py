...
[Serving entry providers](../serving_providers.md) for how to write your own,
and `examples/provider_server/` for a runnable one. Only `sortable=` is
...
Run it with `python examples/query_in_process.py`.
"""

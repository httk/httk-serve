...
Run with::
    ...
    python examples/optimade/demo_server/serve.py
...
from httk.serve.optimade.backend import simple_property_handlers
...
# Run this example by hand (``python examples/optimade/demo_server/serve.py``): it binds
        ...
        links=[
            {
                "id": "index",
                "name": "demo index",
                "description": "Demo OPTIMADE database served by httk-serve",

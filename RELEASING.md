...
3. On PyPI, add a pending GitHub Trusted Publisher with these values:
   ...
   - PyPI project name: `httk-optimade`
   - Owner: `httk`
   - Repository: `httk-optimade`
...
4. Verify the release from a fresh environment with `pip install httk-optimade`.

...
SITE_RESOURCES_KEY = "httk_web_resources"
...
class SiteResources:
    """Callbacks owned by one :class:`httk.web.engine.site_engine.SiteEngine`.
    ...
    when the :class:`httk.web.engine.site_engine.SiteEngine` closes.  Closing is

...
entry_info: dict[str, EntryInfo] = {
    'structures': {
        ...
        'properties': {
            ...
            # Properties added in OPTIMADE v1.2:
            ...
            # Properties added in OPTIMADE v1.3:
            'fractional_site_positions': {
                'description': "Fractional coordinates (positions) of each site in the structure. A site is usually used to describe positions of atoms; what atoms can be encountered at a given site is conveyed by the species_at_sites property, and the species themselves are described in the species property.",
                'type': 'list',
                'fulltype': 'list of list of float',
                'required_support': False,
                'should_support': True,
            ...
            'site_coordinate_span': {
                'description': "Indicates the extent of the material (crystal) described in the response. In particular, properties cartesian_site_positions and fractional_site_positions MUST contain all sites belonging to the described extent.",
                'type': 'string',
                'fulltype': 'string',
                'required_support': False,
                'should_support': True,
    ...
    'files': {
        'description': 'a files entry',
        'properties': {
            'id': {
                'description': "The ID for the files entry.",
                'type': 'string',
                'fulltype': 'string',
                'required_support': True,
                'should_support': True,
            ...
            'type': {
                'description': "The name of the type of this entry, always 'files'",
                'type': 'string',
                'fulltype': 'string',
                'required_support': True,
                'should_support': True,
...
all_entries: list[str] = list(entry_info.keys())

properties_by_entry: dict[str, list[str]] = {x: list(entry_info[x]['properties'].keys()) for x in entry_info}

# In the future, not all properties may be valid response fields
valid_response_fields = properties_by_entry

valid_endpoints: list[str] = ['info', 'all'] + all_entries + [x + "/info" for x in all_entries] + ['']
